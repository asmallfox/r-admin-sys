  ...
  series: [
    {
      ...
      data: [
        { name: '高一', value: 20, label: { color: '#13e560' } },
        { name: '高二', value: 32, label: { color: '#f7ff26' } },
        { name: '高三', value: 20, label: { color: '#fe9400' } }
      ]
    }
  ]
}
...
export const rankingOption: EChartOption = {
  title: {
    text: '排名',
    textStyle: {
      color: '#fff'
...
export const personFinishOption = {}
